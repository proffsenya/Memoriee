...
// Список категорий для отображения (совпадает с возможными при создании)
...
export const LandingPage = () => {
  ...
  // Загружаем события пользователя при монтировании
  useEffect(() => {
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {categories.map((cat) => (
            <Link
              ...
              className="p-3 text-center transition bg-white shadow-sm cursor-pointer rounded-xl hover:shadow-md"
            >
        ...
        {loading ? (
          ...
          <Card className="py-12 text-center">
            ...
            <Link to="/create-event">
              <Button className="mt-4">Создать событие</Button>
            </Link>
          </Card>
        ) : (
